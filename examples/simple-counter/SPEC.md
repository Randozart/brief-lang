...
A minimal counter program demonstrating Briev's contract system.
...
Postconditions define what must be true after a transaction completes. Briev mathematically verifies that the postcondition can be satisfied from the precondition.
