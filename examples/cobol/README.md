# Brief to COBOL Examples

This folder contains Brief source files (`*.bv`) and their generated COBOL equivalents.

## Running Examples

```bash
# Compile to COBOL
cargo run --bin brief-compiler -- cobol examples/cobol/withdraw.bv --out examples/cobol/output/
