...
Brief's event model has zero compiler-generated functions, zero hidden keywords,
...
The same symbol `__wait_for_event` is provided by `runtime/brief_rt.c` (one C
