...
Remove non-essential transpilation targets from CLI, keep only LLVM, Webstack, VHDL, and SystemVerilog. Make `brief build` default to LLVM backend with sensible defaults.
...
## Phase 2 — Make `brief build` default to LLVM
