...
/// Intent: Backend that compiles Briev programs to native Rust source code.
...
impl RustBackend {
    ...
    /// Intent: Generate Rust source code from a Briev program.
    pub fn generate(&mut self, program: &Program) -> String {
        ...
        output.push_str("// Native Rust application - generated by Briev\n");
        ...
        output.push_str("    println!(\"Briev kernel starting\\n\");\n");
        ...
        output.push_str("    println!(\"Briev kernel done\\n\");\n");
        output.push_str("}\n");
    ...
    /// Intent: Convert a Briev statement to Rust code for the generated State impl.
    ...
    /// Intent: Convert a Briev expression to Rust code with self access for state.
    ...
    /// Intent: Convert a Briev expression to Rust code without self prefix for state.
    ...
    /// Intent: Map a Briev type to its native Rust type string.
    ...
    /// Intent: Get the default initialization value for a Briev type in Rust.
    ...
    /// Intent: Sanitize a Briev identifier for use as a Rust name (replace hyphens with underscores).
