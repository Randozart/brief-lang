...
// Archived Rust/wasm-bindgen codegen — replaced by TypeScript emitter (Phase A)
// Extracted from src/backend/webstack.rs on 2026-06-19.
// All functions in this file were part of the Rust/wasm-bindgen codegen pipeline.
