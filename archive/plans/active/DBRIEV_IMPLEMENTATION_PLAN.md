# DBriev Implementation Plan

**Date:** 2026-05-05
**Status:** Planning
**Related:** `docs/reference/DBRIEV_SPEC.md`, `docs/reference/BRIEV-DATALOG_RESEARCH.md`

---

## 1. Scope

Implement DBriev (Data Briev) as a new language variant for configuration and database files, with Briev integration.
...
| Type system | Briev types + Addr, RegOffset | HIGH |
...
| File | Purpose |
|------|---------|
| `src/dbriev/parser.rs` | Parse .dbv/.dbvl/.dbvs files |
| `src/dbriev/eval.rs` | Query evaluation engine |
| `src/dbriev/alloc.rs` | Address allocation |
| `src/dbriev/mod.rs` | Module entry |
| `src/dbriev/ast.rs` | DBriev AST |
...
|--------------|-------------|
| Briev import | `.bv` can import .dbv via FFI |
...
|-----------|--------------|
| `.dbv` parses without error | `briev compile config.dbv` |
