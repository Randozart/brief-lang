...
**Source:** officina-cli development session — ~600 lines of Briev written blind  
...
representation of a token. A `Token::LParen` becomes `Some(Ok(LParen))`. A Briev user has no idea
