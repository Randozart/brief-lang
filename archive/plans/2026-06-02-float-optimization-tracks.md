...
(Briev 0.4231s vs C 0.0432s). Investigation of the C IR revealed that **clang -O3
...
The entire 9-element matrix multiply (12 fmul + fadd) was eliminated. Briev's
...
with zero Q-coefficients — those 6 fields are dead work that Briev shouldn't
pay for. The nonzero variant should match the C variant field-for-field.

**Expected gap**: TBD — this measures the real structural overhead of Briev's
...
| Benchmark | Initial | Matrix | Expected Briev vs C |
|-----------|---------|--------|-------------------|
