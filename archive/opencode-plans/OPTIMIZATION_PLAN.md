# Briev Compiler — Complete Optimization Plan
...
### 5.1 `is_acyclic` Codegen Paths in Briev Backends
...
**What to implement:**
- Briev versions of `aarch64.bv`, `x86_64.bv`, `rust.bv`, `c.bv` must check acyclicity
...
LOW            5.1 Briev backends acyclicity     ~2 days    Last self-hosted mirror item
