...
Briev's reactor runs continuously to evaluate preconditions, but different files have different needs:
...
For Rendered Briev components, this enables powerful optimization:
