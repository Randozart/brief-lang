...
- `EMBEDDED_BRIEF_2.1_SPEC.md` - Previous embedded spec (superseded by EMBEDDED_BRIEF_2.1_SPEC.md)
...
- `RENDERED-BRIEF-GUIDE.md` - Superseded by spec/RENDERED-BRIEF-GUIDE.md
