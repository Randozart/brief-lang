# Embedded Briev 2.2 Specification
...
## 1. Introduction
Embedded Briev 2.2 unifies the logic across **Core Briev (.bv)**, **Rendered Briev (.rbv)**, and **Embedded Briev (.ebv)**. It provides high-velocity hardware primitives for "Silicon Architecting," introducing concepts like vector geometry, cycle-accurate timing, and cross-variant logic sharing.
