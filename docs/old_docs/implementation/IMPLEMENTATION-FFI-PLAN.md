# Briev Compiler FFI Implementation Plan

## Overview

This document outlines the implementation plan for restructuring the Briev compiler's foreign function interface (FFI) system to:
...
```
lib/
├── std/                     // Native Briev implementations
│   └── *.bv
