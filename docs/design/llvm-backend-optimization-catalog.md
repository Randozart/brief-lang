...
This document catalogues every optimization path in the Brief LLVM backend, the conditions that trigger each, and what each path achieves in terms of runtime performance.
