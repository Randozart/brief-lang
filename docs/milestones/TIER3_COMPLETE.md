...
Tier 3 implements the complete lexer (tokenizer) for Briev in pure Briev. No FFI required - uses only Tier 1 and Tier 2 native functions.
...
1. Define AST types in Briev (structs and enums)
