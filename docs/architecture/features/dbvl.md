# Data Briev — Data Files, Schema, and Line Data
...
Data Briev (`.dbv`, `.dbvs`, `.dbvl`) is Briev's universal data format. It serves the same role as JSON, XML, or TOML in other ecosystems but is parsed by the Briev compiler itself.

## File Types

| Extension | Name | Purpose |
|-----------|------|---------|
| `.dbv` | Data Briev | Structured data (think JSON/YAML) |
| `.dbvs` | Data Briev Schema | Validation schema for `.dbv` and `.dbvl` files |
| `.dbvl` | Data Briev Lines | Line-oriented data (one record per line, think JSONL/NDJSON) |
...
Data Briev files are imported into Briev programs:
...
- **Data exchange**: Briev-to-Briev data serialization
