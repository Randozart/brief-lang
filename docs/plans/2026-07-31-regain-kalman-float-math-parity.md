...
| float_math | .0734s | .0739s | 0.99× | Brief | MATCH |
| float_math_nonzero | .2003s | .1644s | 1.21× | C | MATCH |
| sparse_dispatch | .0515s | .0609s | 0.84× | Brief | MATCH |
| print_loop | .0607s | .0587s | 1.03× | C | MATCH |
| nbody_newton | 6.9053s | 8.4097s | 0.82× | Brief | MATCH |
| nbody_sqrt | 2.1862s | 2.7948s | 0.78× | Brief | MATCH |
| nbody_sqrt_idio | 2.7251s | 3.6174s | 0.75× | Brief | MATCH |
| fasta | .2088s | .2109s | 0.99× | Brief | MATCH |
| fannkuch_redux | .0607s | .0651s | 0.93× | Brief | MATCH |
| mandelbrot | .6778s | .6622s | 1.02× | C | MATCH |
| kalman_filter_runtime | .2197s | .1808s | 1.21× | C | MATCH |
| knucleotide | .1873s | .1887s | 0.99× | Brief | MATCH |
| cancel_math | .0535s | .0631s | 0.84× | Brief | MATCH |
| bit_clear | .0003s | .0001s | 3.00× | C | MATCH |
| queue_drain | .0570s | .0611s | 0.93× | Brief | MATCH |
| queue_drain_sym | .0565s | .0610s | 0.92× | Brief | MATCH |
| queue_drain_idio | .0564s | .0618s | 0.91× | Brief | MATCH |
| interval_step | .0629s | .0637s | 0.99× | Brief | MATCH |
...
lib/runtime/brief_rt.c -o <mod>` and time vs the untouched binaries at
...
lib/runtime/brief_rt.c`) and interleaved-timed 5× at BOUND=50000000.
