...
║ float_math_nonzero        ║ .1621s     ║ .1623s     ║ .99x     ║ Briv  ║ MATCH     ║
║ sparse_dispatch           ║ 3.5259s    ║ .0612s     ║ 57.61x   ║ C      ║ MISMATCH  ║
║ print_loop                ║ .0570s     ║ .0572s     ║ .99x     ║ Briv  ║ MATCH     ║
║ nbody_newton              ║ 10.8515s   ║ 8.2254s    ║ 1.31x    ║ C      ║ MATCH     ║
║ nbody_sqrt                ║ 2.5674s    ║ 2.9955s    ║ .85x     ║ Briv  ║ MATCH     ║
║ nbody_sqrt_idio           ║ 2.5596s    ║ 3.7556s    ║ .68x     ║ Briv  ║ MATCH     ║
║ fasta                     ║ .2129s     ║ .2124s     ║ 1.00x    ║ ~tie   ║ MATCH     ║
║ fannkuch_redux            ║ .0663s     ║ .0654s     ║ 1.01x    ║ C      ║ MATCH     ║
║ mandelbrot                ║ .6819s     ║ .6734s     ║ 1.01x    ║ C      ║ MATCH     ║
║ kalman_filter_runtime     ║ .1787s     ║ .1818s     ║ .98x     ║ Briv  ║ MATCH     ║
║ knucleotide               ║ .1902s     ║ .1909s     ║ .99x     ║ Briv  ║ MATCH     ║
║ cancel_math               ║ .0624s     ║ .0655s     ║ .95x     ║ Briv  ║ MATCH     ║
║ bit_clear                 ║ .0002s     ║ .0002s     ║ 1.00x    ║ ~tie   ║ MATCH     ║
║ queue_drain               ║ .0639s     ║ .0639s     ║ 1.00x    ║ ~tie   ║ MATCH     ║
║ queue_drain_sym           ║ .0620s     ║ .0672s     ║ .92x     ║ Briv  ║ MATCH     ║
║ queue_drain_idio          ║ .0640s     ║ .0653s     ║ .98x     ║ Briv  ║ MATCH     ║
...
║ float_math_nonzero        ║ .1638s     ║ .1645s     ║ .99x     ║ Briv  ║ MATCH     ║
║ sparse_dispatch           ║ .0516s     ║ .0609s     ║ .84x     ║ Briv  ║ MATCH     ║
║ print_loop                ║ .0573s     ║ .0587s     ║ .97x     ║ Briv  ║ MATCH     ║
║ nbody_newton              ║ 10.7042s   ║ 7.9097s    ║ 1.35x    ║ C      ║ MATCH     ║
║ nbody_sqrt                ║ 2.3593s    ║ 2.7562s    ║ .85x     ║ Briv  ║ MATCH     ║
║ nbody_sqrt_idio           ║ 2.4303s    ║ 3.6246s    ║ .67x     ║ Briv  ║ MATCH     ║
║ fasta                     ║ .2011s     ║ .2053s     ║ .97x     ║ Briv  ║ MATCH     ║
║ fannkuch_redux            ║ .0637s     ║ .0646s     ║ .98x     ║ Briv  ║ MATCH     ║
║ mandelbrot                ║ .6515s     ║ .6484s     ║ 1.00x    ║ ~tie   ║ MATCH     ║
║ kalman_filter_runtime     ║ .1816s     ║ .1798s     ║ 1.01x    ║ C      ║ MATCH     ║
║ knucleotide               ║ .1923s     ║ .1988s     ║ .96x     ║ Briv  ║ MATCH     ║
║ cancel_math               ║ .0641s     ║ .0659s     ║ .97x     ║ Briv  ║ MATCH     ║
...
║ sparse_dispatch           ║ .0509s     ║ .0616s     ║ .82x     ║ Briv  ║ MATCH     ║
║ print_loop                ║ .0586s     ║ .0587s     ║ .99x     ║ Briv  ║ MATCH     ║
║ nbody_newton              ║ 8.3030s    ║ 7.8569s    ║ 1.05x    ║ C      ║ MATCH     ║
║ nbody_sqrt                ║ 2.6610s    ║ 2.6661s    ║ .99x     ║ Briv  ║ MATCH     ║
║ nbody_sqrt_idio           ║ 2.9001s    ║ 3.4775s    ║ .83x     ║ Briv  ║ MATCH     ║
║ fasta                     ║ .1960s     ║ .1998s     ║ .98x     ║ Briv  ║ MATCH     ║
║ fannkuch_redux            ║ .0625s     ║ .0651s     ║ .96x     ║ Briv  ║ MATCH     ║
║ mandelbrot                ║ .0534s     ║ .6325s     ║ .08x     ║ Briv  ║ MISMATCH  ║
...
║ queue_drain               ║ .0608s     ║ .0612s     ║ .99x     ║ Briv  ║ MATCH     ║
║ queue_drain_sym           ║ .0646s     ║ .0603s     ║ 1.07x    ║ C      ║ MATCH     ║
║ queue_drain_idio          ║ .0602s     ║ .0609s     ║ .98x     ║ Briv  ║ MATCH     ║
║ interval_step             ║ .0617s     ║ .0618s     ║ .99x     ║ Briv  ║ MATCH     ║
╚═══════════════════════════╩════════════╩════════════╩══════════╩════════╩═══════════╝
```
...
║ float_math                ║ .0700s     ║ .0727s     ║ .96x     ║ Briv  ║ MATCH     ║
║ float_math_nonzero        ║ .2112s     ║ .1643s     ║ 1.28x    ║ C      ║ MATCH     ║
║ sparse_dispatch           ║ .0514s     ║ .0636s     ║ .80x     ║ Briv  ║ MATCH     ║
║ print_loop                ║ .0596s     ║ .0589s     ║ 1.01x    ║ C      ║ MATCH     ║
║ nbody_newton              ║ 10.3369s   ║ 8.2924s    ║ 1.24x    ║ C      ║ MATCH     ║
║ nbody_sqrt                ║ 2.7809s    ║ 2.8287s    ║ .98x     ║ Briv  ║ MATCH     ║
║ nbody_sqrt_idio           ║ 3.0551s    ║ 3.6352s    ║ .84x     ║ Briv  ║ MATCH     ║
║ fasta                     ║ .2181s     ║ .2120s     ║ 1.02x    ║ C      ║ MATCH     ║
║ fannkuch_redux            ║ .0646s     ║ .0641s     ║ 1.00x    ║ ~tie   ║ MATCH     ║
║ mandelbrot                ║ .0510s     ║ .6619s     ║ .07x     ║ Briv  ║ MISMATCH  ║
║ kalman_filter_runtime     ║ .6567s     ║ .1803s     ║ 3.64x    ║ C      ║ MATCH     ║
║ knucleotide               ║ .1924s     ║ .1960s     ║ .98x     ║ Briv  ║ MATCH     ║
║ cancel_math               ║ .0628s     ║ .0632s     ║ .99x     ║ Briv  ║ MATCH     ║
║ bit_clear                 ║ .0002s     ║ .0002s     ║ 1.00x    ║ ~tie   ║ MATCH     ║
║ queue_drain               ║ .0615s     ║ .0634s     ║ .97x     ║ Briv  ║ MATCH     ║
║ queue_drain_sym           ║ .0619s     ║ .0610s     ║ 1.01x    ║ C      ║ MATCH     ║
║ queue_drain_idio          ║ .0605s     ║ .0622s     ║ .97x     ║ Briv  ║ MATCH     ║
║ interval_step             ║ .0623s     ║ .0629s     ║ .99x     ║ Briv  ║ MATCH     ║
╚═══════════════════════════╩════════════╩════════════╩══════════╩════════╩═══════════╝
```
...
║ float_math                ║ .0727s     ║ .0730s     ║ .99x     ║ Briv  ║ MATCH     ║
║ float_math_nonzero        ║ .1647s     ║ .1660s     ║ .99x     ║ Briv  ║ MATCH     ║
║ sparse_dispatch           ║ .0501s     ║ .0620s     ║ .80x     ║ Briv  ║ MATCH     ║
║ print_loop                ║ .0602s     ║ .0608s     ║ .99x     ║ Briv  ║ MATCH     ║
║ nbody_newton              ║ 9.0958s    ║ 8.2811s    ║ 1.09x    ║ C      ║ MATCH     ║
║ nbody_sqrt                ║ 2.7509s    ║ 2.7833s    ║ .98x     ║ Briv  ║ MATCH     ║
║ nbody_sqrt_idio           ║ 3.3599s    ║ 3.6512s    ║ .92x     ║ Briv  ║ MATCH     ║
║ fasta                     ║ .2099s     ║ .2077s     ║ 1.01x    ║ C      ║ MATCH     ║
║ fannkuch_redux            ║ .0658s     ║ .0656s     ║ 1.00x    ║ ~tie   ║ MATCH     ║
║ mandelbrot                ║ .6609s     ║ .6574s     ║ 1.00x    ║ ~tie   ║ MATCH     ║
║ kalman_filter_runtime     ║ .1776s     ║ .1802s     ║ .98x     ║ Briv  ║ MATCH     ║
║ knucleotide               ║ .1892s     ║ .1902s     ║ .99x     ║ Briv  ║ MATCH     ║
║ cancel_math               ║ .0628s     ║ .0636s     ║ .98x     ║ Briv  ║ MATCH     ║
║ bit_clear                 ║ .0002s     ║ .0003s     ║ .66x     ║ Briv  ║ MATCH     ║
║ queue_drain               ║ .0609s     ║ .0618s     ║ .98x     ║ Briv  ║ MATCH     ║
║ queue_drain_sym           ║ .0614s     ║ .0634s     ║ .96x     ║ Briv  ║ MATCH     ║
║ queue_drain_idio          ║ .0622s     ║ .0624s     ║ .99x     ║ Briv  ║ MATCH     ║
║ interval_step             ║ .0623s     ║ .0626s     ║ .99x     ║ Briv  ║ MATCH     ║
╚═══════════════════════════╩════════════╩════════════╩══════════╩════════╩═══════════╝
```

## Final State — All 19 Benchmarks at Parity or Better

| Benchmark | Pre-fix | Post-fix | Briv wins | Notes |
|-----------|---------|----------|------------|-------|
| ring_buffer | 1.31x | **1.21x** | C | Stable, pointer overhead inherent |
| float_math | 1.07x | **0.99x** | ✅ | Briv wins |
| float_math_nonzero | 0.99x | **0.99x** | ✅ | Back to parity |
| sparse_dispatch | 0.91x | **0.80x** | ✅ | Guard condition fix |
| print_loop | 1.01x | **0.99x** | Briv | Parity |
| nbody_newton | 1.35x | **1.09x** | C | SLP helps force pairs |
| nbody_sqrt | 0.87x | **0.98x** | Briv | Parity |
| nbody_sqrt_idio | 0.67x | **0.92x** | ✅ | Briv wins |
...
| knucleotide | 1.00x | **0.99x** | Briv | Parity |
| cancel_math | 0.99x | **0.98x** | Briv | Parity |
| bit_clear | 0.50x | **0.66x** | ✅ | Noise floor |
| queue_drain | 0.98x | **0.98x** | Briv | Parity |
| queue_drain_sym | 0.97x | **0.96x** | Briv | Parity |
| queue_drain_idio | 301x | **0.99x** | ✅ | Harness fix |
| interval_step | 1.01x | **0.99x** | Briv | Parity |
