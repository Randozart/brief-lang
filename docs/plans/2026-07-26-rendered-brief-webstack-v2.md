# Plan: Rendered Brief Webstack v2 — WASM-First Architecture

**Date:** 2026-07-26
**Status:** Implementation plan
**Spec:** `docs/architecture/features/rendered-brief-wasm.md`
...
All work happens in a **dedicated git worktree** at `../brief-compiler-wasm-webstack/` to avoid interfering with other agents working on the core compiler.

### Worktree Setup

```bash
cd /home/randozart/Desktop/Projects/brief-compiler
git worktree add -b wasm-webstack-v2 ../brief-compiler-wasm-webstack main
cd ../brief-compiler-wasm-webstack
...
3. **Add `glue/web/types.bv`:**
   ...
   // Maps Brief types to web runtime representations
...
2. **`generate()` emits `dom-shim.mjs` with:**
   ...
   ```javascript
   // Auto-generated by Brief/GLUE Web Generator
...
| Document | Update |
|----------|--------|
| `docs/architecture/features/rendered-brief-wasm.md` | (this spec) — definitive reference |
