...
- Manual: `briev derive --enumerative-depth 4 benchmarks/popcount_derive.bv` completes in <30s
- Manual: `briev derive --enumerative-depth 5 benchmarks/popcount_derive.bv` completes in <120s
