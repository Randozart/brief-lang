...
in the chain. This makes inline assembly safe (verified against a Briev
...
Briev's approach is simpler: test the asm body against a Briev reference
...
- `asm_line` is a Briev string literal containing assembly mnemonics.
