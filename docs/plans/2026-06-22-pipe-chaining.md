...
Briev's reactive transaction model already enables elegant loop/iteration semantics.
...
**Dot ambiguity:** The `.` token in Briev is used for field access (`.field`).
...
| `learn-briev/01-basics.md` | Pipe chaining tutorial section |
