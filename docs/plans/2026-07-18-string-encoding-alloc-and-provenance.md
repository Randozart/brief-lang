...
Four closely related designs that together form Brief's memory model:
...
Alloc#(256, my_custom_alloc_fn)   // identifier — Brief function call
```
...
- Strings are immutable after construction in Brief (every operation creates a new handle)
