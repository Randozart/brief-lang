...
define void @txn_work(ptr noalias nocapture align 8 %state) local_unnamed_addr #0 alwaysinline {
  entry:
  ...
  %t19 = add i64 0, 1
  %t15 = add nsw i64 %t18, %t19
  %t20 = getelementptr inbounds %State, ptr %state, i32 0, i32 1
  store i64 %t15, ptr %t20
  %t24 = getelementptr inbounds %State, ptr %state, i32 0, i32 1
  %t25 = load i64, ptr %t24, align 8
  %t26 = add i64 0, 5000000
  %t22 = srem i64 %t25, %t26
  %t27 = add i64 0, 0
  %t28 = icmp eq i64 %t22, %t27
  %t21 = zext i1 %t28 to i8
  %t30 = trunc i8 %t21 to i1
  ...
  %t35 = load i64, ptr %t34, align 8
   %t32 = call i64 @__print_int(i64 %t35)
  %t37 = add i64 0, 10
   %t36 = call i64 @__print_char(i64 %t37)
  br label %guard.end29
  guard.end29:
  ret void
}

define internal i8 @pre_work(ptr noalias nocapture align 8 %state) #10 {
  entry:
