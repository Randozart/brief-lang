...
%t13 = add i64 0, 1
%t14 = add nsw i64 %t10, %t13
  %ap_15 = getelementptr inbounds %State, ptr %state, i32 0, i32 0
  store i64 %t14, ptr %ap_15, align 8, !tbaa !1
  %fdp19 = getelementptr inbounds %State, ptr %state, i32 0, i32 0
  %t18 = load i64, i64* %fdp19, align 8
%t21 = add i64 0, 5000000
%t22 = srem i64 %t18, %t21
%t24 = add i64 0, 0
%c25 = icmp eq i64 %t22, %t24
  br i1 %c25, label %g26_t, label %g26_e
  g26_t:
    %fdp29 = getelementptr inbounds %State, ptr %state, i32 0, i32 0
    %t28 = load i64, i64* %fdp29, align 8
    %pso30 = load volatile ptr, ptr @stdout
    %pfi31 = getelementptr [5 x i8], [5 x i8]* @FMT_INT, i64 0, i64 0
    %ppi32 = call i32 (ptr, ptr, ...) @fprintf(ptr %pso30, ptr %pfi31, i64 %t28)
    %t27 = zext i32 %ppi32 to i64
    br label %g26_tx
  g26_tx:
    br label %g26_e
  g26_e:
...
%t22 = ptrtoint i8* %sp23 to i64
  ...
  %gt_35 = getelementptr inbounds %StateChunk0, ptr %state_0, i32 0, i32 1
  %cnt_bound_16 = load i64, ptr %gt_35, align 8
  br label %pre_phi
pre_phi:
  %init_cnt_36 = getelementptr inbounds %StateChunk0, ptr %state_0, i32 0, i32 1
  %init_N_37 = load i64, ptr %init_cnt_36, align 8, !tbaa !1, !invariant.load !{}
  %init_cnt_38 = getelementptr inbounds %StateChunk0, ptr %state_0, i32 0, i32 2
  %init_cycle_count_39 = load i64, ptr %init_cnt_38, align 8, !tbaa !1, !invariant.load !{}
  %init_cnt_40 = getelementptr inbounds %StateChunk0, ptr %state_0, i32 0, i32 0
  %init_count_41 = load i64, ptr %init_cnt_40, align 8
  br label %loop_hdr
loop_hdr:
  %pi_cnt_42 = phi i64 [ %init_count_41, %pre_phi ], [ %pn_cnt_42, %latch ]
  %phi_N = phi i64 [ %init_N_37, %pre_phi ], [ %be_N, %latch ]
  %phi_cycle_count = phi i64 [ %init_cycle_count_39, %pre_phi ], [ %be_cycle_count, %latch ]
  %phi_ops = phi i64 [ %init_count_41, %pre_phi ], [ %be_ops, %latch ]
  %cmp_hdr_43 = icmp slt i64 %pi_cnt_42, %cnt_bound_16
  br i1 %cmp_hdr_43, label %body, label %done
body:
  %t45 = add i64 0, %phi_ops
%t47 = add i64 0, 1
%t48 = add nsw i64 %t45, %t47
  %ap_49 = getelementptr inbounds %StateChunk0, ptr %state_0, i32 0, i32 0
  store i64 %t48, ptr %ap_49, align 8, !tbaa !1
  %t52 = add i64 0, %t48
%t54 = add i64 0, 5000000
%t55 = srem i64 %t52, %t54
%t57 = add i64 0, 0
%c58 = icmp eq i64 %t55, %t57
  br i1 %c58, label %g59_t, label %g59_e
  g59_t:
    %t61 = add i64 0, %t48
    %pso62 = load volatile ptr, ptr @stdout
    %pfi63 = getelementptr [5 x i8], [5 x i8]* @FMT_INT, i64 0, i64 0
    %ppi64 = call i32 (ptr, ptr, ...) @fprintf(ptr %pso62, ptr %pfi63, i64 %t61)
    %t60 = zext i32 %ppi64 to i64
    br label %g59_tx
  g59_tx:
    br label %g59_e
  g59_e:
