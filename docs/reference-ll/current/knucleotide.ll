...
%StateChunk0 = type { i64, i64, i64, i64, i64, i64 }
%State = type { i64, i64, i64, i64, i64, i64 }
...
define void @txn_kn(ptr noundef noalias nocapture align 8 %state) local_unnamed_addr #0 alwaysinline {
  entry:
  ...
  %t28 = getelementptr inbounds %State, ptr %state, i32 0, i32 3
  ...
  %t31 = and i64 %t15, %t33
  %t25 = or i64 %t26, %t31
  %t34 = load i64, ptr @MASK
  %t24 = and i64 %t25, %t34
  %t36 = getelementptr inbounds %State, ptr %state, i32 0, i32 2
  store i64 %t15, ptr %t36
  %t39 = getelementptr inbounds %State, ptr %state, i32 0, i32 4
  %t40 = load i64, ptr %t39, align 8
  %t43 = add i64 0, 13
  %t41 = srem i64 %t24, %t43
  %t37 = add nsw i64 %t40, %t41
  %t45 = getelementptr inbounds %State, ptr %state, i32 0, i32 3
  store i64 %t24, ptr %t45
  %t47 = getelementptr inbounds %State, ptr %state, i32 0, i32 4
  store i64 %t37, ptr %t47
  %t51 = getelementptr inbounds %State, ptr %state, i32 0, i32 0
  %t52 = load i64, ptr %t51, align 8
  %t53 = add i64 0, 5000000
  %t49 = srem i64 %t52, %t53
  %t54 = add i64 0, 0
  %t55 = icmp eq i64 %t49, %t54
  %t48 = zext i1 %t55 to i8
  %t57 = trunc i8 %t48 to i1
  br i1 %t57, label %guard.then56, label %guard.end56
  guard.then56:
   %t59 = call i64 @__print_int(i64 %t37)
  %t62 = add i64 0, 10
   %t61 = call i64 @__print_char(i64 %t62)
  br label %guard.end56
  guard.end56:
  %t66 = getelementptr inbounds %State, ptr %state, i32 0, i32 0
  %t67 = load i64, ptr %t66, align 8
  %t68 = add i64 0, 1
  %t64 = add nsw i64 %t67, %t68
  %t69 = getelementptr inbounds %State, ptr %state, i32 0, i32 0
  store i64 %t64, ptr %t69
  ret void
}

define internal i8 @pre_kn(ptr noundef noalias nocapture align 8 %state) #10 {
  entry:
...
entry:
  ...
  %clb17 = getelementptr inbounds %State, ptr %state, i32 0, i32 1
  %whb16 = load i64, ptr %clb17, align 8
  br label %.wloop
.wloop:
  %t18 = getelementptr inbounds %State, ptr %state, i32 0, i32 0
  %t19 = load i64, ptr %t18, align 8
  %whd20 = icmp slt i64 %t19, %whb16
  br i1 %whd20, label %.wbody, label %.wend
.wbody:
  %t25 = getelementptr inbounds %State, ptr %state, i32 0, i32 2
  %t26 = load i64, ptr %t25, align 8
  %t27 = load i64, ptr @IA
  %t23 = mul nsw i64 %t26, %t27
  %t28 = load i64, ptr @IC
  %t22 = add nsw i64 %t23, %t28
  %t29 = load i64, ptr @IM
  %t21 = srem i64 %t22, %t29
  %t34 = getelementptr inbounds %State, ptr %state, i32 0, i32 3
  ...
  %t37 = and i64 %t21, %t39
  %t31 = or i64 %t32, %t37
  %t40 = load i64, ptr @MASK
  %t30 = and i64 %t31, %t40
  %t43 = getelementptr inbounds %State, ptr %state, i32 0, i32 4
  %t44 = load i64, ptr %t43, align 8
  %t47 = add i64 0, 13
  %t45 = srem i64 %t30, %t47
  %t41 = add nsw i64 %t44, %t45
  %cms49 = getelementptr inbounds %State, ptr %state, i32 0, i32 2
  store i64 %t21, ptr %cms49, align 8
  %cms51 = getelementptr inbounds %State, ptr %state, i32 0, i32 3
  store i64 %t30, ptr %cms51, align 8
  %cms53 = getelementptr inbounds %State, ptr %state, i32 0, i32 4
  store i64 %t41, ptr %cms53, align 8
  %t57 = getelementptr inbounds %State, ptr %state, i32 0, i32 0
  %t58 = load i64, ptr %t57, align 8
  %t59 = add i64 0, 5000000
  %t55 = srem i64 %t58, %t59
  %t60 = add i64 0, 0
  %t61 = icmp eq i64 %t55, %t60
  %t54 = zext i1 %t61 to i8
  %tb62 = trunc i8 %t54 to i1
  br i1 %tb62, label %.cmgb63, label %.cmgn63
.cmgb63:
   %t65 = call i64 @__print_int(i64 %t41)
  %t68 = add i64 0, 10
   %t67 = call i64 @__print_char(i64 %t68)
  br label %.cmgn63
.cmgn63:
  %t71 = getelementptr inbounds %State, ptr %state, i32 0, i32 0
  %t72 = load i64, ptr %t71, align 8
  %t73 = add i64 0, 1
  %t69 = add nsw i64 %t72, %t73
  %cms74 = getelementptr inbounds %State, ptr %state, i32 0, i32 0
  store i64 %t69, ptr %cms74, align 8
  %whn75 = add nuw nsw i64 %t19, 1
  %t76 = getelementptr inbounds %State, ptr %state, i32 0, i32 0
  store i64 %whn75, ptr %t76, align 8
