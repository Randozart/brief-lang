...
define void @txn_work(ptr noundef noalias nocapture align 8 %state) local_unnamed_addr #11 alwaysinline {
  entry:
  %t6 = getelementptr inbounds %State, ptr %state, i32 0, i32 2
...
.wbody:
  %t20 = getelementptr inbounds %State, ptr %state, i32 0, i32 2
  %t21 = load i64, ptr %t20, align 8
  %cms22 = getelementptr inbounds %State, ptr %state, i32 0, i32 1
  store i64 %t21, ptr %cms22, align 8
  ...
  %cms32 = getelementptr inbounds %State, ptr %state, i32 0, i32 2
  store i64 %t27, ptr %cms32, align 8
  %t36 = add i64 0, 5000000
  %t34 = srem i64 %t27, %t36
  %t37 = add i64 0, 0
  %t38 = icmp eq i64 %t34, %t37
  %t33 = zext i1 %t38 to i8
  %tb39 = trunc i8 %t33 to i1
  br i1 %tb39, label %.cmgb40, label %.cmgn40
.cmgb40:
   %t42 = call i64 @__print_int(i64 %t27)
  %t45 = add i64 0, 10
   %t44 = call i64 @__print_char(i64 %t45)
  br label %.cmgn40
.cmgn40:
  %whn46 = add nuw nsw i64 %t17, 1
  %t47 = getelementptr inbounds %State, ptr %state, i32 0, i32 2
  store i64 %whn46, ptr %t47, align 8
