...
define void @txn_fasta(ptr noundef noalias nocapture align 8 %state) local_unnamed_addr #0 alwaysinline {
  entry:
  ...
  %t24 = getelementptr inbounds %State, ptr %state, i32 0, i32 2
  store i64 %t15, ptr %t24
  %t27 = getelementptr inbounds %State, ptr %state, i32 0, i32 0
  %t28 = load i64, ptr %t27, align 8
  %t29 = add i64 0, 1
  %t25 = add nsw i64 %t28, %t29
  %t30 = getelementptr inbounds %State, ptr %state, i32 0, i32 0
  store i64 %t25, ptr %t30
  %t35 = getelementptr inbounds %State, ptr %state, i32 0, i32 2
  %t36 = load i64, ptr %t35, align 8
  %t37 = add i64 0, 26
  %t33 = srem i64 %t36, %t37
  %t38 = add i64 0, 97
  %t32 = add nsw i64 %t33, %t38
   %t31 = call i64 @__print_char(i64 %t32)
  ret void
}

define internal i8 @pre_fasta(ptr noundef noalias nocapture align 8 %state) #10 {
  entry:
...
entry:
  ...
  %clb15 = getelementptr inbounds %State, ptr %state, i32 0, i32 1
...
.wbody:
  %t23 = getelementptr inbounds %State, ptr %state, i32 0, i32 2
  %t24 = load i64, ptr %t23, align 8
  %t25 = load i64, ptr @IA
  %t21 = mul nsw i64 %t24, %t25
  %t26 = load i64, ptr @IC
  %t20 = add nsw i64 %t21, %t26
  %t27 = load i64, ptr @IM
  %t19 = srem i64 %t20, %t27
  %cms28 = getelementptr inbounds %State, ptr %state, i32 0, i32 2
  store i64 %t19, ptr %cms28, align 8
  %t33 = add i64 0, 26
  %t31 = srem i64 %t19, %t33
  %t34 = add i64 0, 97
  %t30 = add nsw i64 %t31, %t34
   %t29 = call i64 @__print_char(i64 %t30)
  %t37 = getelementptr inbounds %State, ptr %state, i32 0, i32 0
  %t38 = load i64, ptr %t37, align 8
  %t39 = add i64 0, 1
  %t35 = add nsw i64 %t38, %t39
  %cms40 = getelementptr inbounds %State, ptr %state, i32 0, i32 0
  store i64 %t35, ptr %cms40, align 8
  %whn41 = add nuw nsw i64 %t17, 1
  %t42 = getelementptr inbounds %State, ptr %state, i32 0, i32 0
  store i64 %whn41, ptr %t42, align 8
