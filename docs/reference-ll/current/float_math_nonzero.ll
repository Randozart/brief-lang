...
define void @txn_tick(ptr noundef noalias nocapture align 8 %state) local_unnamed_addr #11 alwaysinline {
  ...
  %t91 = getelementptr inbounds %State, ptr %state, i32 0, i32 2
  store float %t49, ptr %t91
  %t93 = getelementptr inbounds %State, ptr %state, i32 0, i32 1
  store float %t32, ptr %t93
  %t95 = getelementptr inbounds %State, ptr %state, i32 0, i32 0
  store float %t15, ptr %t95
  ...
  guard.then104:
    %t106 = getelementptr inbounds %State, ptr %state, i32 0, i32 3
    %t107 = load float, ptr %t106
    %t108 = getelementptr inbounds %State, ptr %state, i32 0, i32 4
    %t109 = load float, ptr %t108
    %t110 = getelementptr inbounds %State, ptr %state, i32 0, i32 5
    %t111 = load float, ptr %t110
    %t112 = getelementptr inbounds %State, ptr %state, i32 0, i32 0
    %t113 = load float, ptr %t112
    %t114 = getelementptr inbounds %State, ptr %state, i32 0, i32 1
    %t115 = load float, ptr %t114
    %t116 = getelementptr inbounds %State, ptr %state, i32 0, i32 2
    %t117 = load float, ptr %t116
    call void @txn_tick_cold_0(float %t107, float %t109, float %t111, float %t113, float %t115, float %t117)
    br label %guard.end104
  guard.end104:
  ret void
}
define void @txn_tick_cold_0(float %__cp_p00, float %__cp_p11, float %__cp_p22, float %__cp_x0, float %__cp_x1, float %__cp_x2) local_unnamed_addr #0 {
  %t120 = fadd fast float %__cp_p00, %__cp_p11
  %t119 = fadd fast float %t120, %__cp_p22
  %t127 = fadd fast float %__cp_x0, %__cp_x1
  %t126 = fadd fast float %t127, %__cp_x2
  %t125 = fadd fast float %t126, %t119
   %t124 = call i64 @__print_float(float %t125)
  %t133 = add i64 0, 10
