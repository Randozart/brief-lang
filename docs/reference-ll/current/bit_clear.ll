...
define void @txn_clear_bit(ptr noundef noalias nocapture align 8 %state) local_unnamed_addr #0 alwaysinline {
  entry:
...
define internal i8 @pre_clear_bit(ptr noundef noalias nocapture align 8 %state) #10 {
  entry:
