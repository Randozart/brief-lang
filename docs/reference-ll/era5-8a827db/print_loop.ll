...
define i64 @get_env_int(ptr noalias nocapture align 8 %state, ptr %arg0) local_unnamed_addr #8 {
  ...
  %ac0 = ptrtoint ptr %arg0 to i64
  %t1 = add i64 0, %ac0
  %gsr2 = inttoptr i64 %t1 to ptr
  %gsp3 = bitcast ptr %gsr2 to ptr
  %gdp4 = load i64, ptr %gsp3, align 8
  %gnp5 = inttoptr i64 %gdp4 to ptr
  %gnv6 = call ptr @getenv(ptr %gnp5)
  %gnvl7 = icmp eq ptr %gnv6, null
  br i1 %gnvl7, label %genv_nul8, label %genv_ok9
  genv_nul8:
    br label %genv_af10
  genv_ok9:
  %gav11 = call i64 @atol(ptr %gnv6)
    br label %genv_af10
  genv_af10:
  %t0 = phi i64 [ 0, %genv_nul8 ], [ %gav11, %genv_ok9 ]
  ret i64 %t0
}
...
%t6 = add i64 0, 0
%c7 = icmp sgt i64 %t3, %t6
  %fdp10 = getelementptr inbounds %State, ptr %state, i32 0, i32 1
  %t9 = load i64, i64* %fdp10, align 8
  %fdp12 = getelementptr inbounds %State, ptr %state, i32 0, i32 0
  %t11 = load i64, i64* %fdp12, align 8
%c13 = icmp slt i64 %t9, %t11
  %t1 = and i1 %c7, %c13
  %pi14 = and i1 %t1, true
  br i1 %pi14, label %ps16, label %pp15
  pp15:
    unreachable
  ps16:
  call void @llvm.assume(i1 %pi14)
  %fdp19 = getelementptr inbounds %State, ptr %state, i32 0, i32 1
  %t18 = load i64, i64* %fdp19, align 8
%t21 = add i64 0, 1
%t22 = add nsw i64 %t18, %t21
  %ap_23 = getelementptr inbounds %State, ptr %state, i32 0, i32 1
  store i64 %t22, ptr %ap_23, align 8, !tbaa !1
  %fdp27 = getelementptr inbounds %State, ptr %state, i32 0, i32 1
  %t26 = load i64, i64* %fdp27, align 8
%t29 = add i64 0, 100000
%t30 = srem i64 %t26, %t29
%t32 = add i64 0, 0
%c33 = icmp eq i64 %t30, %t32
  br i1 %c33, label %g34_t, label %g34_e
  g34_t:
    %fdp37 = getelementptr inbounds %State, ptr %state, i32 0, i32 1
    %t36 = load i64, i64* %fdp37, align 8
    %pso38 = load volatile ptr, ptr @stdout
    %pfi39 = getelementptr [5 x i8], [5 x i8]* @FMT_INT, i64 0, i64 0
    %ppi40 = call i32 (ptr, ptr, ...) @fprintf(ptr %pso38, ptr %pfi39, i64 %t36)
    %t35 = zext i32 %ppi40 to i64
    br label %g34_tx
  g34_tx:
    br label %g34_e
  g34_e:
...
%t2 = ptrtoint i8* %sp3 to i64
  %cip4 = inttoptr i64 %t2 to ptr
  %t0 = call i64 @get_env_int(ptr %state, ptr %cip4)
  store i64 %t0, ptr %ip_0, align 8
  %ip_1 = getelementptr inbounds %State, ptr %state, i32 0, i32 1
%t6 = add i64 0, 0
  store i64 %t6, ptr %ip_1, align 8
...
define i32 @main() local_unnamed_addr #9 {
  ...
  %ip_7 = getelementptr inbounds %StateChunk0, ptr %state_0, i32 0, i32 0
%sp11 = getelementptr inbounds [6 x i8], [6 x i8]* @str.3, i64 0, i64 0
%t10 = ptrtoint i8* %sp11 to i64
  %cip12 = inttoptr i64 %t10 to ptr
  %t8 = call i64 @get_env_int(ptr %state, ptr %cip12)
  store i64 %t8, ptr %ip_7, align 8
  %ip_13 = getelementptr inbounds %StateChunk0, ptr %state_0, i32 0, i32 1
%t15 = add i64 0, 0
  store i64 %t15, ptr %ip_13, align 8
  %ip_16 = getelementptr inbounds %StateChunk0, ptr %state_0, i32 0, i32 2
  store i64 0, ptr %ip_16, align 8
  ...
  %gt_17 = getelementptr inbounds %StateChunk0, ptr %state_0, i32 0, i32 0
  %cnt_bound_7 = load i64, ptr %gt_17, align 8
  br label %pre_phi
pre_phi:
  %init_cnt_18 = getelementptr inbounds %StateChunk0, ptr %state_0, i32 0, i32 0
  %init_bound_19 = load i64, ptr %init_cnt_18, align 8, !tbaa !1
  %init_cnt_20 = getelementptr inbounds %StateChunk0, ptr %state_0, i32 0, i32 2
  %init_cycle_count_21 = load i64, ptr %init_cnt_20, align 8, !tbaa !1, !invariant.load !{}
  %init_cnt_22 = getelementptr inbounds %StateChunk0, ptr %state_0, i32 0, i32 1
  %init_count_23 = load i64, ptr %init_cnt_22, align 8
  br label %loop_hdr
loop_hdr:
  %pi_cnt_24 = phi i64 [ %init_count_23, %pre_phi ], [ %pn_cnt_24, %latch ]
  %phi_cycle_count = phi i64 [ %init_cycle_count_21, %pre_phi ], [ %be_cycle_count, %latch ]
  %phi_bound = phi i64 [ %init_bound_19, %pre_phi ], [ %be_bound, %latch ]
  %phi_ops = phi i64 [ %init_count_23, %pre_phi ], [ %be_ops, %latch ]
  %cmp_hdr_25 = icmp slt i64 %pi_cnt_24, %cnt_bound_7
  br i1 %cmp_hdr_25, label %body, label %done
body:
  %t27 = add i64 0, %phi_ops
%t29 = add i64 0, 1
%t30 = add nsw i64 %t27, %t29
  %ap_31 = getelementptr inbounds %StateChunk0, ptr %state_0, i32 0, i32 1
  store i64 %t30, ptr %ap_31, align 8, !tbaa !1
  %t34 = add i64 0, %t30
%t36 = add i64 0, 100000
%t37 = srem i64 %t34, %t36
%t39 = add i64 0, 0
%c40 = icmp eq i64 %t37, %t39
  br i1 %c40, label %g41_t, label %g41_e
  g41_t:
    %t43 = add i64 0, %t30
    %pso44 = load volatile ptr, ptr @stdout
    %pfi45 = getelementptr [5 x i8], [5 x i8]* @FMT_INT, i64 0, i64 0
    %ppi46 = call i32 (ptr, ptr, ...) @fprintf(ptr %pso44, ptr %pfi45, i64 %t43)
    %t42 = zext i32 %ppi46 to i64
    br label %g41_tx
  g41_tx:
    br label %g41_e
  g41_e:
