...
Historical and supplementary documentation for the Briev compiler.

## Files

| File | Description |
|------|-------------|
| `BRIEV-DATALOG_RESEARCH.md` | Research on Datalog integration |
| `BRIEV_LANGUAGE_REFERENCE.md` | Language reference (v0.12.0) - compare with spec/LANGUAGE-TUTORIAL.md |
...
- `BRIEV_LANGUAGE_REFERENCE.md` and `spec/LANGUAGE-TUTORIAL.md` may have overlapping content - consider consolidating
