# Briev Compiler Target Abstraction Layer (TAL)
...
The Briev compiler currently embeds vendor-specific "magic" words directly in its Rust source code:
...
# Map clean Briev names to AXI physical port names
[port_map]
clock = "s_axi_aclk"
...
module {module_name}_axi_wrapper (
    ...
    // User Logic Outputs (connected to clean Briev module)
    ...
    // Instantiate the clean Briev module
...
| **No Magic Leakage** | Users write pure Briev, magic stays in TOML |
