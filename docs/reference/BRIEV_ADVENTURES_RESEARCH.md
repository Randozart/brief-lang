# Research: Briev + DBriev Text Adventure Engine

## Concept: "The Briev Adventures"

This document explores how to build a Zork-style text adventure using Briev + DBriev. This is **research**, not an implementation plan.
...
DBriev naturally supports save/load:
...
3. **Natural save/load**: DBriev data is inherently serializable
4. **Reactive UI**: Briev + RBV updates views automatically
...
- [ ] Graphics view (SVG from DBriev geometry data)

---

## 10. Conclusion

Briev + DBriev provides a clean separation for game development:
- **DBriev** handles the declarative world state
- **Briev** handles the imperative logic
...
*The text adventure was the perfect testing ground for languages. Briev + DBriev could be too.*