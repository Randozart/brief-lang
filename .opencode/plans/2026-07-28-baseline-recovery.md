...
The baseline worktree is at `../brief-compiler-baseline` with a release build ready.
To rebuild: `cd ../brief-compiler-baseline && cargo build --release`
...
5. Update 3 functions that were missing `align 8` (reactor_tick seq/par, __brief_init_state).
...
emit_toplevel.rs:2491   __brief_init_state (add align 8 + noalias)
...
if local_txn_attr == "#11" {
    ...
    for (name, ty) in &self.ctx.field_brief_types.zip(self.ctx.field_index_map.keys()) {
...
║ float_math                ║ .0725s     ║ .0760s     ║ .95x     ║ Brief  ║ MATCH     ║
║ float_math_nonzero        ║ .1663s     ║ .1682s     ║ .98x     ║ Brief  ║ MATCH     ║
║ sparse_dispatch           ║ .0548s     ║ .0641s     ║ .85x     ║ Brief  ║ MATCH     ║
║ print_loop                ║ .0650s     ║ .0631s     ║ 1.03x    ║ C      ║ MATCH     ║
║ nbody_newton              ║ 9.4851s    ║ 8.5580s    ║ 1.10x    ║ C      ║ MATCH     ║
║ nbody_sqrt                ║ 2.7581s    ║ 2.7962s    ║ .98x     ║ Brief  ║ MATCH     ║
║ nbody_sqrt_idio           ║ 3.3699s    ║ 3.6140s    ║ .93x     ║ Brief  ║ MATCH     ║
║ fasta                     ║ .2108s     ║ .2112s     ║ .99x     ║ Brief  ║ MATCH     ║
║ fannkuch_redux            ║ .0629s     ║ .0646s     ║ .97x     ║ Brief  ║ MATCH     ║
║ mandelbrot                ║ .6593s     ║ .6572s     ║ 1.00x    ║ ~tie   ║ MATCH     ║
║ kalman_filter_runtime     ║ .1808s     ║ .1797s     ║ 1.00x    ║ ~tie   ║ MATCH     ║
║ knucleotide               ║ .1901s     ║ .1920s     ║ .99x     ║ Brief  ║ MATCH     ║
║ cancel_math               ║ .0618s     ║ .0642s     ║ .96x     ║ Brief  ║ MATCH     ║
║ bit_clear                 ║ .0002s     ║ .0003s     ║ .66x     ║ Brief  ║ MATCH     ║
║ queue_drain               ║ .0618s     ║ .0630s     ║ .98x     ║ Brief  ║ MATCH     ║
║ queue_drain_sym           ║ .0612s     ║ .0618s     ║ .99x     ║ Brief  ║ MATCH     ║
║ queue_drain_idio          ║ .0595s     ║ .0635s     ║ .93x     ║ Brief  ║ MATCH     ║
║ interval_step             ║ .0612s     ║ .0626s     ║ .97x     ║ Brief  ║ MATCH     ║
╚═══════════════════════════╩════════════╩════════════╩══════════╩════════╩═══════════╝
```
...
║ sparse_dispatch           ║ .0517s     ║ .0598s     ║ .86x     ║ Brief  ║ MATCH     ║
║ print_loop                ║ .0598s     ║ .0599s     ║ .99x     ║ Brief  ║ MATCH     ║
║ nbody_newton              ║ 9.1881s    ║ 8.5377s    ║ 1.07x    ║ C      ║ MATCH     ║
║ nbody_sqrt                ║ 3.1200s    ║ 3.0291s    ║ 1.03x    ║ C      ║ MATCH     ║
║ nbody_sqrt_idio           ║ 3.6215s    ║ 4.0243s    ║ .89x     ║ Brief  ║ MATCH     ║
...
║ cancel_math               ║ .0631s     ║ .0635s     ║ .99x     ║ Brief  ║ MATCH     ║
║ bit_clear                 ║ .0004s     ║ .0003s     ║ 1.33x    ║ C      ║ MATCH     ║
║ queue_drain               ║ .0619s     ║ .0646s     ║ .95x     ║ Brief  ║ MATCH     ║
...
- nbody_newton (Brief min 8.95s→9.62s, C avg 8.54s→8.84s)
- fasta (Brief min 0.205s→0.228s, C avg 0.211s→0.230s)
- nbody_sqrt (C avg 2.80s→3.12s — pure noise, Brief stable at ~3.0s)
...
| Benchmark | Step 3 (reverted) | Step 4 (re-applied) | Brief Delta |
|-----------|-------------------|--------------------|-------------|
...
| fasta | .93x (.221s) | 1.05x (.229s) | C faster (.236→.218s); Brief stable |
| All others | parity | parity | Within noise |

**Verdict: Step 4 is clean.** The original "regression" was thermal throttling noise from back-to-back benchmark runs without cooldown. Both Step 3 and Step 4 produce identical IR for benchmarks with no applicable `!range` metadata. ring_buffer's Brief time improved from .0567s to .0512s (−9.7%) from the `!range` on `ops`.
...
║ float_math                ║ .0721s     ║ .0740s     ║ .97x     ║ Brief  ║ MATCH     ║
║ float_math_nonzero        ║ .1663s     ║ .1667s     ║ .99x     ║ Brief  ║ MATCH     ║
║ sparse_dispatch           ║ .0528s     ║ .0608s     ║ .86x     ║ Brief  ║ MATCH     ║
║ print_loop                ║ .0579s     ║ .0580s     ║ .99x     ║ Brief  ║ MATCH     ║
║ nbody_newton              ║ 9.0454s    ║ 8.2543s    ║ 1.09x    ║ C      ║ MATCH     ║
║ nbody_sqrt                ║ 2.8100s    ║ 2.7976s    ║ 1.00x    ║ ~tie   ║ MATCH     ║
║ nbody_sqrt_idio           ║ 3.3549s    ║ 3.6367s    ║ .92x     ║ Brief  ║ MATCH     ║
║ fasta                     ║ .2094s     ║ .2204s     ║ .95x     ║ Brief  ║ MATCH     ║
║ fannkuch_redux            ║ .0681s     ║ .0648s     ║ 1.05x    ║ C      ║ MATCH     ║
║ mandelbrot                ║ .6702s     ║ .6648s     ║ 1.00x    ║ ~tie   ║ MATCH     ║
║ kalman_filter_runtime     ║ .1801s     ║ .1817s     ║ .99x     ║ Brief  ║ MATCH     ║
║ knucleotide               ║ .1963s     ║ .1906s     ║ 1.02x    ║ C      ║ MATCH     ║
║ cancel_math               ║ .0645s     ║ .0635s     ║ 1.01x    ║ C      ║ MATCH     ║
║ queue_drain               ║ .0600s     ║ .0616s     ║ .97x     ║ Brief  ║ MATCH     ║
...
```
../brief-compiler/                     # Main repo (integration target)
../brief-compiler-baseline/            # Read-only A/B comparison at b39461e2
../brief-compiler-recovery/            # ACTIVE — recovery-branch @ b39461e2
...
| `cargo build --release` | `../brief-compiler-recovery` | Build the recovery compiler |
| `bash benchmarks/build_and_bench.sh --runtime` | `../brief-compiler` | Script uses relative path to baseline |
| `bash benchmarks/compare_baseline.sh <name>` | `../brief-compiler` | Script looks for `../brief-compiler-baseline` |
| Single bmark compile | `../brief-compiler-recovery` | Use our compiler binary |
| `git commit` | `../brief-compiler-recovery` | Commits go on `recovery-branch` |

### Integration with Derivation Feature Worktree

The derive worktree (`../brief-compiler-derive`) holds 12 code commits for the
