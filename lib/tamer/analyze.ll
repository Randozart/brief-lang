...
define i64 @read_u8(ptr noundef noalias nocapture align 8 %state, ptr %arg0, i64 %arg1) local_unnamed_addr #8 {
  entry:
  %ac0 = ptrtoint ptr %arg0 to i64
  %t0 = bitcast ptr %ac0 to i64
  %t4 = add i64 0, 8
  %t2 = sdiv i64 %arg1, %t4
  %t9 = add i64 0, 8
  %t7 = mul nsw i64 %t2, %t9
  %t5 = add nsw i64 %t0, %t7
  %t11 = bitcast i64 %t5 to ptr
...
define ptr @find_bounty_section(ptr noundef noalias nocapture align 8 %state, ptr %arg0, i64 %arg1) local_unnamed_addr #8 {
  ...
  guard.end8:
  %t30 = add i64 0, 2
  %t31 = icmp sge i64 %t0, %t30
  %t28 = zext i1 %t31 to i8
  %t33 = trunc i8 %t28 to i1
  br i1 %t33, label %guard.then32, label %guard.end32
  guard.then32:
  %t37 = add i64 0, 38
  %t38 = inttoptr i64 %ac0 to ptr
  %t35 = call i64 @read_u8(ptr %state, ptr %t38, i64 %t37)
  %t40 = icmp eq i64 %t35, %arg1
  %t34 = zext i1 %t40 to i8
  %t42 = trunc i8 %t34 to i1
  br i1 %t42, label %guard.then41, label %guard.end41
  guard.then41:
  %t47 = add i64 0, 39
  %t48 = inttoptr i64 %ac0 to ptr
  %t45 = call i64 @read_u64(ptr %t48, i64 %t47)
  %t43 = add nsw i64 %ac0, %t45
  ret ptr %t43
  ...
  guard.end32:
  %t54 = add i64 0, 3
  %t55 = icmp sge i64 %t0, %t54
  %t52 = zext i1 %t55 to i8
  %t57 = trunc i8 %t52 to i1
  br i1 %t57, label %guard.then56, label %guard.end56
  guard.then56:
  %t61 = add i64 0, 55
  %t62 = inttoptr i64 %ac0 to ptr
  %t59 = call i64 @read_u8(ptr %state, ptr %t62, i64 %t61)
  %t64 = icmp eq i64 %t59, %arg1
  %t58 = zext i1 %t64 to i8
  %t66 = trunc i8 %t58 to i1
  br i1 %t66, label %guard.then65, label %guard.end65
  guard.then65:
  %t71 = add i64 0, 56
  %t72 = inttoptr i64 %ac0 to ptr
  %t69 = call i64 @read_u64(ptr %t72, i64 %t71)
  %t67 = add nsw i64 %ac0, %t69
  ret ptr %t67
  br label %guard.end65
  guard.end65:
...
define i64 @compute_stack_slots(ptr %arg0, i64 %arg1, ptr %arg2, i64 %arg3) local_unnamed_addr #8 {
  entry:
  %ac0 = ptrtoint ptr %arg0 to i64
  %ac2 = ptrtoint ptr %arg2 to i64
...
define i64 @compute_locals_slots(ptr %arg0, i64 %arg1, ptr %arg2, i64 %arg3) local_unnamed_addr #8 {
  entry:
  %ac0 = ptrtoint ptr %arg0 to i64
  %ac2 = ptrtoint ptr %arg2 to i64
  %t5 = inttoptr i64 %ac0 to ptr
...
define i64 @compute_frames_max(ptr %arg0, i64 %arg1, ptr %arg2, i64 %arg3) local_unnamed_addr #8 {
  entry:
  %ac0 = ptrtoint ptr %arg0 to i64
  %ac2 = ptrtoint ptr %arg2 to i64
  %t2 = add i64 0, 16
...
define i64 @analyze_fn_stack_loop(ptr noundef noalias nocapture align 8 %state, ptr %arg0, i64 %arg1, i64 %arg2, i64 %arg3, i64 %arg4) local_unnamed_addr #8 {
  ...
  br label %loop
loop:
  %p0_l24 = load i64, ptr %p0_s, align 8
  %p1_l25 = load i64, ptr %p1_s, align 8
  %p2_l26 = load i64, ptr %p2_s, align 8
  %p3_l27 = load i64, ptr %p3_s, align 8
  %p4_l28 = load i64, ptr %p4_s, align 8
