...
define i64 @vm_loop(ptr noundef noalias nocapture align 8 %state, ptr %arg0, ptr %arg1, ptr %arg2, ptr %arg3, i64 %arg4, ptr %arg5, i64 %arg6, i64 %arg7, ptr %arg8, i64 %arg9, i64 %arg10, i64 %arg11) local_unnamed_addr #8 {
  ...
  br label %loop
loop:
  %p0_l38 = load i64, ptr %p0_s, align 8
  %p1_l39 = load i64, ptr %p1_s, align 8
  %p2_l40 = load i64, ptr %p2_s, align 8
  %p3_l41 = load i64, ptr %p3_s, align 8
  %p4_l42 = load i64, ptr %p4_s, align 8
  %p5_l43 = load i64, ptr %p5_s, align 8
  %p6_l44 = load i64, ptr %p6_s, align 8
  %p7_l45 = load i64, ptr %p7_s, align 8
  %p8_l46 = load i64, ptr %p8_s, align 8
  %p9_l47 = load i64, ptr %p9_s, align 8
  %p10_l48 = load i64, ptr %p10_s, align 8
  %p11_l49 = load i64, ptr %p11_s, align 8
