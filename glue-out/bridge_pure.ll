...
%PyMethodDef = type { i64, i64, i64, i64 }
%PyModuleDef = type { i64, i64, i64, i64, i64, i64, i64, i64, i64 }
%PyModuleDef_Base = type { i64, i64, i64 }
...
declare ptr @PyLong_FromLongLong(i64) #6
declare i64 @mul(i64, i64) #6
declare i64 @add(i64, i64) #6
declare ptr @PyModule_Create2(ptr, i64) #6
...
define ptr @pybridge_add(ptr %arg0, ptr %arg1) local_unnamed_addr #8 {
  entry:
...
define ptr @pybridge_mul(ptr %arg0, ptr %arg1) local_unnamed_addr #8 {
  entry:
  %ac0 = ptrtoint ptr %arg0 to i64
  %ac1 = ptrtoint ptr %arg1 to i64
    %t0 = add i64 0, 0
...
define ptr @PyInit_bridge() local_unnamed_addr #8 {
  entry:
