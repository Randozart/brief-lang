...
define void @work(%State* noalias nocapture %state) local_unnamed_addr #0 alwaysinline {
  ...
  g49_t:
    ...
    %t51 = add i64 0, %il53
    %t50 = call i64 @__print_int(i64 %t51)
    br label %g49_e
  g49_e:
  ret void
}
...
case_body4:
  %N_old_11 = extractvalue %State %ssa_phi_case, 0
  %queue_old_12 = extractvalue %State %ssa_phi_case, 2
  %count_old_13 = extractvalue %State %ssa_phi_case, 1
  %t16 = add i64 0, %queue_old_12
  ...
  %t32 = add i64 0, %count_old_13
  %t33 = add i64 0, 1
  %t31 = add i64 %t32, %t33
  %in34 = insertvalue %State %ssa_phi_case, i64 %t31, 1
  %t37 = add i64 0, %count_old_13
  ...
  g42_t:
    %t44 = add i64 0, %count_old_13
    %t43 = call i64 @__print_int(i64 %t44)
    br label %g42_e
  g42_e:
  %N_old_45 = extractvalue %State %in34, 0
  %queue_old_46 = extractvalue %State %in34, 2
  %count_old_47 = extractvalue %State %in34, 1
  %t50 = add i64 0, %queue_old_46
  ...
  %t66 = add i64 0, %count_old_47
  %t67 = add i64 0, 1
  %t65 = add i64 %t66, %t67
  %in68 = insertvalue %State %in34, i64 %t65, 1
  %t71 = add i64 0, %count_old_47
  ...
  g76_t:
    %t78 = add i64 0, %count_old_47
    %t77 = call i64 @__print_int(i64 %t78)
    br label %g76_e
  g76_e:
  %N_old_79 = extractvalue %State %in68, 0
  %queue_old_80 = extractvalue %State %in68, 2
  %count_old_81 = extractvalue %State %in68, 1
  %t84 = add i64 0, %queue_old_80
  ...
  g110_t:
    %t112 = add i64 0, %count_old_81
    %t111 = call i64 @__print_int(i64 %t112)
    br label %g110_e
  g110_e:
  %N_old_113 = extractvalue %State %in102, 0
  %queue_old_114 = extractvalue %State %in102, 2
  %count_old_115 = extractvalue %State %in102, 1
  %t118 = add i64 0, %queue_old_114
  ...
  g144_t:
    %t146 = add i64 0, %count_old_115
    %t145 = call i64 @__print_int(i64 %t146)
    br label %g144_e
  g144_e:
  store %State %in136, %State* %slot_case, align 8
  br label %case_hdr
case_body1:
  %N_old_147 = extractvalue %State %ssa_phi_case, 0
  %queue_old_148 = extractvalue %State %ssa_phi_case, 2
  %count_old_149 = extractvalue %State %ssa_phi_case, 1
  %t152 = add i64 0, %queue_old_148
  ...
  g178_t:
    %t180 = add i64 0, %count_old_149
    %t179 = call i64 @__print_int(i64 %t180)
    br label %g178_e
  g178_e:
