...
A collection of compiler achievements where Brief's LLVM backend produces
...
- `.bv` — Brief source files demonstrating the achievement
...
| Trophy | Benchmark | Ratio | Brief vs C |
|--------|-----------|-------|------------|
| [slp-hazard](slp-hazard/) | nbody_sqrt | **0.82x** | Brief **1.22x faster** |
| [float-boxing](float-boxing/) | float_math | **0.66x** | Brief **1.52x faster** |
...
| [dispatch-collapse](dispatch-collapse/) | ring_buffer | **0.80x** | Brief **1.25x faster** |
| [equality-saturation](equality-saturation/) | cancel_math | **0.5x** | Brief beats C via fold |
| [direct-ssa-loop](direct-ssa-loop/) | nbody_newton | **0.6x** | Brief **1.6x faster** |
| [benchmarks](benchmarks/) | all | **7 of 10** | Brief beats C |
