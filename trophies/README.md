# Trophy Benchmarks — Where Briev Beats C

## What is this?

A collection of compiler achievements where Briev's LLVM backend produces
...
- `.bv` — Briev source files demonstrating the achievement
...
| Trophy | Benchmark | Ratio | Briev vs C |
|--------|-----------|-------|------------|
| [slp-hazard](slp-hazard/) | nbody_sqrt | **0.82x** | Briev **1.22x faster** |
| [float-boxing](float-boxing/) | float_math | **0.66x** | Briev **1.52x faster** |
...
| [dispatch-collapse](dispatch-collapse/) | ring_buffer | **0.80x** | Briev **1.25x faster** |
| [equality-saturation](equality-saturation/) | cancel_math | **0.5x** | Briev beats C via fold |
| [direct-ssa-loop](direct-ssa-loop/) | nbody_newton | **0.6x** | Briev **1.6x faster** |
| [benchmarks](benchmarks/) | all | **7 of 10** | Briev beats C |

## How to reproduce

```bash
# Build the Briev compiler
cargo build --release
