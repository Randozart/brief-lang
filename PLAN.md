# Briev Compiler — VHDL Backend Completion Plan
...
- **CLI dispatch** (`main.rs:1414-1429`): `briev vhdl <file> --hw <board.dbv>`
...
Complete the `briev_type_to_vhdl()` method to handle all `Type` variants:
...
- Asserts expected outputs from Briev contracts
