...
**Date:** 2026-07-31
**Commit:** `5fed0573` (FDD worktree at `../brief-compiler-fdd`, branch `feat/frontend-driven-dispatch`)
**Compiler code equivalent to:** `666fb502` (baseline worktree `../brief-compiler-baseline`)
...
| Benchmark | Brief time | Ratio | Winner | Correct |
|-----------|-----------:|:-----:|:------:|:-------:|
| ring_buffer | 0.0543s | 1.13× | C | MATCH |
| float_math | 0.0721s | 0.97× | Brief | MATCH |
| float_math_nonzero | 0.2082s | 1.24× | C | MATCH |
| sparse_dispatch | 0.0527s | 0.84× | Brief | MATCH |
| print_loop | 0.0620s | 1.01× | C | MATCH |
| nbody_newton | 6.8833s | 0.83× | Brief | MATCH |
| nbody_sqrt | 2.1812s | 0.77× | Brief | MATCH |
| nbody_sqrt_idio | 2.7124s | 0.75× | Brief | MATCH |
| fasta | 0.2040s | 0.97× | Brief | MATCH |
| fannkuch_redux | 0.0621s | 0.97× | Brief | MATCH |
| mandelbrot | 0.6769s | 1.02× | C | MATCH |
| kalman_filter_runtime | 0.2191s | 1.22× | C | MATCH |
| knucleotide | 0.1874s | 0.99× | Brief | MATCH |
| cancel_math | 0.0519s | 0.85× | Brief | MATCH |
| bit_clear | 0.0001s | ~tie | ~tie | MATCH |
| queue_drain | 0.0540s | 0.86× | Brief | MATCH |
| queue_drain_sym | 0.0553s | 0.89× | Brief | MATCH |
| queue_drain_idio | 0.0567s | 0.94× | Brief | MATCH |
