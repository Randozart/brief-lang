...
All hardcoded Briev type-name matches in `src/backend/llvm/` replaced:
...
| Benchmark | Phase 3 Briev | Phase 3 ratio | Phase 2 ratio | Δ | Winner | Correct |
|-----------|--------------:|:-------------:|:-------------:|:---:|:------:|:-------:|
| ring_buffer | 0.0524s | 1.13× | 1.18× | −0.05 | C | MATCH |
| float_math | 0.0734s | 0.99× | 0.97× | +0.02 | Briev | MATCH |
| float_math_nonzero | 0.2003s | 1.21× | 1.20× | +0.01 | C | MATCH |
| sparse_dispatch | 0.0515s | 0.84× | 0.86× | −0.02 | Briev | MATCH |
| print_loop | 0.0607s | 1.03× | 1.06× | −0.03 | C | MATCH |
| nbody_newton | 6.9053s | 0.82× | 0.83× | −0.01 | Briev | MATCH |
| nbody_sqrt | 2.1862s | 0.78× | 0.78× | 0.00 | Briev | MATCH |
| nbody_sqrt_idio | 2.7251s | 0.75× | 0.76× | −0.01 | Briev | MATCH |
| fasta | 0.2088s | 0.99× | 1.01× | −0.02 | Briev | MATCH |
| fannkuch_redux | 0.0607s | 0.93× | 0.97× | −0.04 | Briev | MATCH |
| mandelbrot | 0.6778s | 1.02× | 1.03× | −0.01 | C | MATCH |
| kalman_filter_runtime | 0.2197s | 1.21× | 1.23× | −0.02 | C | MATCH |
| knucleotide | 0.1873s | 0.99× | 0.98× | +0.01 | Briev | MATCH |
| cancel_math | 0.0535s | 0.84× | 0.80× | +0.04 | Briev | MATCH |
| bit_clear | 0.0003s | 3.00× | 0× | (noise) | C | MATCH |
| queue_drain | 0.0570s | 0.93× | 0.85× | +0.08 | Briev | MATCH |
| queue_drain_sym | 0.0565s | 0.92× | 0.92× | 0.00 | Briev | MATCH |
| queue_drain_idio | 0.0564s | 0.91× | 0.93× | −0.02 | Briev | MATCH |
| interval_step | 0.0629s | 0.99× | 1.01× | −0.02 | Briev | MATCH |
