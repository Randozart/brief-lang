...
| Benchmark | Briev | C | Ratio | Winner | Correct | Δ vs baseline |
|-----------|:-----:|:--:|:-----:|:------:|:-------:|:------------:|
| ring_buffer | .0519s | .0439s | 1.18× | C | MATCH | +.02 |
| float_math | .0422s | .0703s | .60× | Briev | MATCH | 0 |
| float_math_nonzero | .1569s | .1646s | .95× | Briev | MATCH | 0 |
| sparse_dispatch | .0474s | .0597s | .79× | Briev | MATCH | −.02 |
| print_loop | .0329s | .0562s | .58× | Briev | MATCH | −.01 |
| nbody_newton | 7.4724s | 8.9388s | .83× | Briev | MATCH | 0 |
| nbody_sqrt | 2.3246s | 2.9984s | .77× | Briev | MATCH | +.01 |
| nbody_sqrt_idio | 2.9184s | 3.8474s | .75× | Briev | MATCH | 0 |
| fasta | .2180s | .2191s | .99× | Briev | MATCH | −.07 |
| fannkuch_redux | .0594s | .0643s | .92× | Briev | MATCH | −.02 |
| mandelbrot | .7047s | .6855s | 1.02× | C | MATCH | 0 |
| kalman_filter_runtime | .1521s | .1782s | .85× | Briev | MATCH | 0 |
| knucleotide | .1896s | .1903s | .99× | Briev | MATCH | 0 |
| cancel_math | .0512s | .0589s | .86× | Briev | MATCH | +.01 |
| bit_clear | .0002s | .0002s | 1.00× | ~tie | MATCH | −.25 |
| interval_step | .0585s | .0600s | .97× | Briev | MATCH | −.03 |
| telemetry_stream | .1915s | .1984s | .96× | Briev | MATCH | 0 |
| pid_control | .3406s | .3468s | .98× | Briev | MATCH | 0 |
| matrix_pipeline | .4622s | .7192s | .64× | Briev | MATCH | +.02 |
| accumulator_flush | .1059s | .1495s | .70× | Briev | MATCH | −.01 |
