...
| Benchmark | Phase 1b Briev | Phase 1b ratio | Phase 0 ratio | Winner | Correct |
|-----------|---------------:|:--------------:|:-------------:|:------:|:-------:|
| ring_buffer | 0.0516s | 1.10× | 1.13× | C | MATCH |
| float_math | 0.0727s | 0.95× | 0.97× | Briev | MATCH |
| float_math_nonzero | 0.2007s | 1.21× | 1.24× | C | MATCH |
| sparse_dispatch | 0.0507s | 0.82× | 0.84× | Briev | MATCH |
| print_loop | 0.0626s | 1.05× | 1.01× | C | MATCH |
| nbody_newton | 6.9163s | 0.83× | 0.83× | Briev | MATCH |
| nbody_sqrt | 2.1631s | 0.77× | 0.77× | Briev | MATCH |
| nbody_sqrt_idio | 2.7575s | 0.75× | 0.75× | Briev | MATCH |
| fasta | 0.2085s | 0.98× | 0.97× | Briev | MATCH |
| fannkuch_redux | 0.0614s | 0.95× | 0.97× | Briev | MATCH |
| mandelbrot | 0.6842s | 1.03× | 1.02× | C | MATCH |
| kalman_filter_runtime | 0.2193s | 1.24× | 1.22× | C | MATCH |
| knucleotide | 0.1891s | 0.99× | 0.99× | Briev | MATCH |
| cancel_math | 0.0538s | 0.85× | 0.85× | Briev | MATCH |
| bit_clear | 0.0002s | 0.33× | ~tie | Briev | MATCH |
| queue_drain | 0.0564s | 0.93× | 0.86× | Briev | MATCH |
| queue_drain_sym | 0.0564s | 0.90× | 0.89× | Briev | MATCH |
| queue_drain_idio | 0.0564s | 0.91× | 0.94× | Briev | MATCH |
...
`666fb502` baseline). bit_clear improved from ~tie to 0.33× (Briev 0.0002s vs C
...
- The `info: txn … dispatched via …` warnings are recorded in `self.warnings`
  but not printed by `brievc build`; the `.ll` header-label markers are the
