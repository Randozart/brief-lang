...
//! Briev negotiates memory layouts with foreign languages and treats
//! them as districts within the Briev metropolis.
...
// Wait for Briev to send a request
