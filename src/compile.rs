...
fn parse(file_path: &str, tokens: &[(Token, std::ops::Range<usize>)], source: &str) -> Result<Vec<crate::ast::TopLevel>, String> {
...
fn check_types(items: &[crate::ast::TopLevel]) -> Result<(), String> {
...
fn codegen(items: &[crate::ast::TopLevel]) -> Result<String, String> {
    ...
    for item in items {
        if let crate::ast::TopLevel::Definition(defn) = item {
...
fn codegen_definition(defn: &crate::ast::Definition, out: &mut String) -> Result<(), String> {
    use std::fmt::Write;
