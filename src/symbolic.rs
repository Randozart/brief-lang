...
Expr::Term | Expr::Slice { .. } | Expr::MultiSlice { .. } | Expr::Block(_, _) | Expr::TupleDestructure(_, _) | Expr::Tuple(_) | Expr::Concat(_, _) | Expr::Cast(_, _) | Expr::Match { .. } | Expr::BinaryOp(_) | Expr::UnaryOp(_) => SymbolicValue::Unknown,
