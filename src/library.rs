...
/// Parse, type-check, and resolve imports for a Briv source file.
...
/// 2026-07-22: Made public for use by `briv export` CLI subcommand.
pub fn generate_with_exports(items: &[TopLevel], _file_path: &str) -> Result<String, String> {
    let mut out = String::new();
    out.push_str("; Generated by Briv Compiler (library mode)\n");
