...
pub fn projection_target_name(target: &crate::ast::ProjectionTarget) -> String {
    ...
    match target {
        ...
        ProjectionTarget::FnPtr => "FnPtr".into(),
        ProjectionTarget::FnName => "FnName".into(),
        ProjectionTarget::FnParams => "FnParams".into(),
        ProjectionTarget::FnReturns => "FnReturns".into(),
        ProjectionTarget::FnArity => "FnArity".into(),
        ProjectionTarget::FnLoc => "FnLoc".into(),
        ProjectionTarget::FnDoc => "FnDoc".into(),
        ProjectionTarget::FnHash => "FnHash".into(),
        ProjectionTarget::FnContracts => "FnContracts".into(),
        ProjectionTarget::FnModule => "FnModule".into(),
        ProjectionTarget::FnIsPure => "FnIsPure".into(),
