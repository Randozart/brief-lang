// ── SoA Reorder Projection — the second compiler-in-Brief handoff ──────
// 2026-08-04 (plan 2026-08-04-compiler-in-brief-dogfood-ffi, P5): serializes
// the input to `soa_reorder::reorder_fields` into the permutation-only form
// the Brief pass (lib/compiler/soa_reorder.bv) reads. Rust walks the AST and
...
// Brief decides which prefix groups are SAFE (≥2 members, no sibling refs)
...
//   nonfloat <m> <itemidx> ...
//
// Undo: if the Brief pass is ever removed, delete this module and the
// reorder_fields_brief dispatch in soa_reorder.rs.
